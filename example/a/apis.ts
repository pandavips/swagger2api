...
export default {
  ...
  AssetChangeLogExportExcelGET: (
    ...
    return request({
      url: `/assetChangeLog/exportExcel?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  DepositExportExcelGET: (
    ...
    return request({
      url: `/deposit/exportExcel?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  GameStatisticsChannelExportExcelGET: (
    ...
    return request({
      url: `/game/statistics/channel/exportExcel?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  GameStatisticsProxyExportExcelGET: (
    ...
    return request({
      url: `/game/statistics/proxy/exportExcel?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  OperateConfigAchievingGetAchievingConditionsGET: (
    ...
    return request({
      url: `/operate/config/achieving/getAchievingConditions?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  RebateRecordExportExcelGET: (
    ...
    return request({
      url: `/rebate/record/exportExcel?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  SettleAgentExportExcelGET: (
    ...
    return request({
      url: `/settle/agent/exportExcel?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  SettlePlatformExportExcelGET: (
    ...
    return request({
      url: `/settle/platform/exportExcel?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  SettleProxyExportExcelGET: (
    ...
    return request({
      url: `/settle/proxy/exportExcel?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  ThirdPartyPaymentDeleteGET: (
    ...
    return request({
      url: `/thirdPartyPayment/delete?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  ThirdPartyPaymentDetailGET: (
    ...
    return request({
      url: `/thirdPartyPayment/detail?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
   ...
   */
  UserChildUpdateRolePOST: (
    data: IUpdateChildRoleReq,
    config:Partial<ExtraInInternalAxiosRequestConfig>={}
  ): Promise<null> => {
    return request({
      url: `/user/child/updateRole`,
      method: "POST",
            data: data,
            ...config
    });
  ...
  UserGameExportExcelGET: (
    ...
    return request({
      url: `/user/game/exportExcel?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  UserStatisticsExportExcelGET: (
    ...
    return request({
      url: `/user/statistics/exportExcel?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  WinningsRecordExportExcelGET: (
    ...
    return request({
      url: `/winnings/record/exportExcel?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
  ...
  WithdrawDigitalExportExcelGET: (
    ...
    return request({
      url: `/withdraw/digital/exportExcel?${qs.stringify(data)}`,
      method: "GET",
            ...config
    });
  },
