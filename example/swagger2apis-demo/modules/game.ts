...
export default (request) => {
  return {
    ...
    GameChannelQueryAllPOST: (config = {}): Promise<IGameChannelSummary[]> => {
      return request({
    ...
    /**
      ...
      */
    GameChannelStatementQueryPOST: (data: IGameChannelStatementReq = {}, config = {}): Promise<IPageResultGameChannelStatementResp> => {
      return request({
    ...
    GameFactoryQueryAllPOST: (config = {}): Promise<string[]> => {
      return request({
    ...
    GameGameTypeQueryAllPOST: (config = {}): Promise<IChannelTypeResp[]> => {
      return request({
    ...
    /**
      ...
      */
    GameGetChoicePOST: (data: IProxyIdReq = {}, config = {}): Promise<IProxyChoiceGameResp[]> => {
      return request({
        url: `/game/getChoice`,
        method: "POST",
        data,
    ...
    /**
      ...
      */
    GameOfflinePOST: (data: IProxyGameIdReq = {}, config = {}): Promise<null> => {
      return request({
        url: `/game/offline`,
        method: "POST",
        data,
    ...
    /**
      ...
      */
    GameOnlinePOST: (data: IProxyGameIdReq = {}, config = {}): Promise<null> => {
      return request({
        url: `/game/online`,
        method: "POST",
        data,
    ...
    /**
      ...
      */
    GameQueryAreaGamePOST: (data: IAreaIdReq = {}, config = {}): Promise<IProxyGameResp[]> => {
      return request({
    ...
    /**
      ...
      */
    GameQueryListPOST: (data: IQueryProxyGameReq = {}, config = {}): Promise<IPageResultProxyGameResp> => {
      return request({
        url: `/game/queryList`,
        method: "POST",
        data,
    ...
    GameQueryProxyGamePOST: (config = {}): Promise<IProxyGameResp[]> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordChesscardPOST: (data: IChessCardGameRecordReq = {}, config = {}): Promise<IPageResultChessCardGameRecordResp> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordChesscardExportGET: (data: IGamerecordchesscardExportQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordChickenPOST: (data: IChickenGameRecordReq = {}, config = {}): Promise<IPageResultChickenGameRecordResp> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordChickenExportGET: (data: IGamerecordchickenExportQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordElectronPOST: (data: IElectronGameRecordReq = {}, config = {}): Promise<IPageResultElectronGameRecordResp> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordElectronExportGET: (data: IGamerecordelectronExportQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordEsportPOST: (data: IEsportGameRecordReq = {}, config = {}): Promise<IPageResultEsportGameRecordResp> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordEsportExportGET: (data: IGamerecordesportExportQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordFishPOST: (data: IFishGameRecordReq = {}, config = {}): Promise<IPageResultFishGameRecordResp> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordFishExportGET: (data: IGamerecordfishExportQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordLivevideoPOST: (data: ILiveVideoGameRecordReq = {}, config = {}): Promise<IPageResultLiveVideoGameRecordResp> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordLivevideoExportGET: (data: IGamerecordlivevideoExportQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordLotteryPOST: (data: ILotteryGameRecordReq = {}, config = {}): Promise<IPageResultLotteryGameRecordResp> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordLotteryExportGET: (data: IGamerecordlotteryExportQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordOrdinaryPOST: (data: IOrdinaryGameRecordReq = {}, config = {}): Promise<IPageResultOrdinaryGameRecordResp> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordOrdinaryExportGET: (data: IGamerecordordinaryExportQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordSportPOST: (data: ISportGameRecordReq = {}, config = {}): Promise<IPageResultSportGameRecordResp> => {
      return request({
    ...
    /**
      ...
      */
    GameRecordSportExportGET: (data: IGamerecordsportExportQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    GameStatisticsChannelExportExcelGET: (data: IGamestatisticschannelexportExcelQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    GameStatisticsChannelListPOST: (data: IGameUserStatisticsReq = {}, config = {}): Promise<IPageResultGameUserStatisticsResp> => {
      return request({
    ...
    /**
      ...
      */
    GameStatisticsProxyExportExcelGET: (data: IGamestatisticsproxyexportExcelQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    GameStatisticsProxyListPOST: (data: IStatisticsReq = {}, config = {}): Promise<IPageResultGameProxyStatisticsResp> => {
      return request({
    ...
    /**
      ...
      */
    GameStatisticsProxySummaryPOST: (data: ISummaryReq = {}, config = {}): Promise<IGameProxyStatisticsResp> => {
      return request({
    ...
    GameTypeGameMainTypeListPOST: (config = {}): Promise<IGameMainTypeResp[]> => {
      return request({
    ...
    GameTypeGameTypeListPOST: (config = {}): Promise<IGameChannelTypeResp[]> => {
      return request({
    ...
    /**
      ...
      */
    GameUpdateAreaPOST: (data: IProxyGameUpdateAreaReq = {}, config = {}): Promise<null> => {
      return request({
        url: `/game/updateArea`,
        method: "POST",
        data,
    ...
    /**
      ...
      */
    GameUpdateChoiceGamePOST: (data: IUpdateProxyChoiceGameReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    GameUpdateGamePOST: (data: IUpdateProxyGameReq = {}, config = {}): Promise<null> => {
      return request({
        url: `/game/updateGame`,
        method: "POST",
        data,
    ...
    /**
      ...
      */
    GameUpdatePopularPOST: (data: IProxyGameUpdatePopularReq = {}, config = {}): Promise<null> => {
      return request({
