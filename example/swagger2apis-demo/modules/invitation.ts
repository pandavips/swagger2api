...
export default (request) => {
  return {
    /**
      ...
      */
    InvitationPosterAddPosterPOST: (data: IAddPosterReq = {}, config = {}): Promise<number> => {
      return request({
    ...
    /**
      ...
      */
    InvitationPosterOfflinePosterPOST: (data: IOperationPosterReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    InvitationPosterOnlinePosterPOST: (data: IOperationPosterReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    InvitationPosterQueryListPOST: (data: IPaging = {}, config = {}): Promise<IPageResultProxyInvitationPosterResp> => {
      return request({
    ...
    /**
      ...
      */
    InvitationPosterQueryOnePOST: (data: IOperationPosterReq = {}, config = {}): Promise<IProxyInvitationPosterResp> => {
      return request({
    ...
    /**
      ...
      */
    InvitationPosterUpdatePosterPOST: (data: IUpdatePosterReq = {}, config = {}): Promise<null> => {
      return request({
