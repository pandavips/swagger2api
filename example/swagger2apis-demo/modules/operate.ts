...
export default (request) => {
  return {
    ...
    OperateConfigAchievingGetAchievingConditionsGET: (
      data: IOperateconfigachievinggetAchievingConditionsQueryParams = {},
      config = {}
    ): Promise<IProxyAchievingConditionsResp> => {
      return request({
    ...
    /**
      ...
      */
    OperateConfigAchievingUpdateAchievingConditionsPOST: (data: IUpdateAchievingConditionsReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    OperateConfigCenterGetProxyConfigGET: (config = {}): Promise<IProxyRelationConfigResp> => {
      return request({
    ...
    /**
      ...
      */
    OperateConfigCenterUpdateBankCardTopUpPOST: (data: IUpdateBankCardTopUpReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    OperateConfigCenterUpdateCommissionMultiplePOST: (data: IUpdateCommissionMultipleReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    OperateConfigCenterUpdateDepositMultiplePOST: (data: IChongZhiLiuShuiYouXiaoBeiShu = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    OperateConfigCenterUpdateInvitationCodeSetPOST: (data: IUpdateInvitationCodeSetReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    OperateConfigCenterUpdateMinimumBalancePOST: (data: IUpdateMinimumBalanceReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    OperateConfigCenterUpdateRegisterAmountPOST: (data: IZhuCeShuLiangXianZhi = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    OperateConfigCenterUpdateThirdTopUpPOST: (data: IUpdateThirdTopUpReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    OperateConfigCenterUpdateUserBankCardAmountPOST: (data: IXiuGaiYongHuYinHangKaBangDingShuLiang = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    OperateConfigCenterUpdateUserRelationAccountPOST: (data: IHuiYuanGuanLianZhangHao = {}, config = {}): Promise<null> => {
      return request({
    ...
    OperateConfigGameScaleGetGameScaleGET: (config = {}): Promise<IProxyGameScaleResp[]> => {
      return request({
    ...
    OperateConfigGameScaleUpdateGameScalePOST: (data: IUpdateGameScaleReq[] = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    OperateConfigIpControlAddPOST: (data: IIpGuiZeTianJiaCanShu = {}, config = {}): Promise<null> => {
      return request({
    ...
    OperateConfigIpControlDel$id$POST: (code: string = "", config = {}): Promise<null> => {
      return request({
    ...
    /**
     * @description: ip访问限制-删除  */
    OperateConfigIpControlDelByCodePOST: (code: string = "", config = {}): Promise<null> => {
      return request({
        url: `/operate/config/ipControl/del/${code}`,
        method: "POST",
        ...config
    ...
    /**
     * @description: ip访问限制-删除  */
    OperateConfigIpControlDelByCodeIdPOST: (code: string = "", config = {}): Promise<null> => {
      return request({
        url: `/operate/config/ipControl/del/${code}`,
        method: "POST",
        ...config
    ...
    /**
      ...
      */
    OperateConfigIpControlListPOST: (data: IFangWenKongZhiLieBiaoCanShu = {}, config = {}): Promise<IPageResultipGuiZeVo> => {
      return request({
    ...
    OperateConfigIpControlRegionListPOST: (config = {}): Promise<IDiQuMingZhiDuiXiang[]> => {
      return request({
    ...
    /**
     * @description: 客服配置-删除  */
    OperateCustomerServiceDelete$id$POST: (code: string = "", config = {}): Promise<null> => {
      return request({
    ...
    /**
     * @description: 客服配置-删除  */
    OperateCustomerServiceDeleteByCodePOST: (code: string = "", config = {}): Promise<null> => {
      return request({
        url: `/operate/customer/service/delete/${code}`,
        method: "POST",
        ...config
    ...
    /**
     * @description: 客服配置-删除  */
    OperateCustomerServiceDeleteByCodeIdPOST: (code: string = "", config = {}): Promise<null> => {
      return request({
        url: `/operate/customer/service/delete/${code}`,
        method: "POST",
        ...config
    ...
    /**
      ...
      */
    OperateCustomerServicePagePOST: (data: IPeiZhiChaXunDuiXiang = {}, config = {}): Promise<IPageResultBaoWangShangKeFuPeiZhiXinXi> => {
      return request({
    ...
    /**
      ...
      */
    OperateCustomerServiceSavePOST: (data: IBaoWangShangKeFuPeiZhiCanShuDuiXiang = {}, config = {}): Promise<null> => {
      return request({
    ...
    OperateCustomerServiceStatus$id$$status$POST: (code: string = "", config = {}): Promise<null> => {
      return request({
    ...
    /**
     * @description: 客服配置-修改状态  */
    OperateCustomerServiceStatusByCode$status$POST: (code: string = "", config = {}): Promise<null> => {
      return request({
        url: `/operate/customer/service/status/${code}/${code}`,
        method: "POST",
        ...config
    ...
    /**
     * @description: 客服配置-修改状态  */
    OperateCustomerServiceStatusByCodeId$status$POST: (code: string = "", config = {}): Promise<null> => {
      return request({
        url: `/operate/customer/service/status/${code}/${code}`,
        method: "POST",
        ...config
    ...
    /**
      ...
      */
    OperateCustomerService$id$POST: (code: string = "", config = {}): Promise<IBaoWangShangKeFuPeiZhiXinXi> => {
      return request({
    ...
    /**
      ...
      */
    OperateCustomerServiceByCodePOST: (code: string = "", config = {}): Promise<IBaoWangShangKeFuPeiZhiXinXi> => {
      return request({
        url: `/operate/customer/service/${code}`,
        method: "POST",
        ...config
    ...
    /**
      ...
      */
    OperateCustomerServiceByCodeIdPOST: (code: string = "", config = {}): Promise<IBaoWangShangKeFuPeiZhiXinXi> => {
      return request({
        url: `/operate/customer/service/${code}`,
        method: "POST",
        ...config
    ...
    /**
      ...
      */
    OperateGetAchievingPOST: (data: IUserAchievingReq = {}, config = {}): Promise<IUserAchievingBo> => {
      return request({
    ...
    /**
      ...
      */
    OperateValidMembersGetProxyValidMembersGET: (config = {}): Promise<IProxyValidMembersResp> => {
      return request({
    ...
    /**
      ...
      */
    OperateValidMembersUpdateValidMembersPOST: (data: IUpdateValidMembersReq = {}, config = {}): Promise<null> => {
      return request({
