...
export default (request) => {
  return {
    /**
          ...
          */
    SiteMessageListPOST: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    SiteMessageManualSendPOST: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    SiteMessageManualSysCompensatePOST: (data = {}, config = {}) => {
      return request({
    ...
    SiteMessageQueryPushWayGET: (config = {}) => {
      return request({
    ...
    /**
          ...
          */
    SiteMessageReadListPOST: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    SiteMessageRollbackPOST: (data = {}, config = {}) => {
      return request({
