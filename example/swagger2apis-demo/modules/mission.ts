...
export default (request) => {
  return {
    /**
      ...
      */
    MissionChangeOrderPUT: (data: IMissionInfoOrderReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    MissionChangeStatusPUT: (data: IMissionInfoStatusReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    MissionConfigQueryGET: (config = {}): Promise<IMissionConfigResp> => {
      return request({
    ...
    /**
      ...
      */
    MissionConfigSavePOST: (data: IMissionConfigReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    MissionDelete$missionId$DELETE: (code: string = "", config = {}): Promise<null> => {
      return request({
    ...
    /**
     * @description: 主任务-删除主任务  */
    MissionDeleteByCodeDELETE: (code: string = "", config = {}): Promise<null> => {
      return request({
        url: `/mission/delete/${code}`,
        method: "DELETE",
        ...config
    ...
    /**
     * @description: 主任务-删除主任务  */
    MissionDeleteByCodeMissionIdDELETE: (code: string = "", config = {}): Promise<null> => {
      return request({
        url: `/mission/delete/${code}`,
        method: "DELETE",
        ...config
    ...
    /**
      ...
      */
    MissionDescriptionExistMissionNamePOST: (data: IMissionNameReq = {}, config = {}): Promise<boolean> => {
      return request({
    ...
    MissionPreDelete$missionId$GET: (code: string = "", config = {}): Promise<number> => {
      return request({
    ...
    /**
     * @description: 主任务-预删除主任务  */
    MissionPreDeleteByCodeGET: (code: string = "", config = {}): Promise<number> => {
      return request({
        url: `/mission/preDelete/${code}`,
        method: "GET",
        ...config
    ...
    /**
     * @description: 主任务-预删除主任务  */
    MissionPreDeleteByCodeMissionIdGET: (code: string = "", config = {}): Promise<number> => {
      return request({
        url: `/mission/preDelete/${code}`,
        method: "GET",
        ...config
    ...
    /**
      ...
      */
    MissionQueryDetail$missionId$GET: (code: string = "", config = {}): Promise<IMissionInfoQueryOneResp> => {
      return request({
    ...
    /**
      ...
      */
    MissionQueryDetailByCodeGET: (code: string = "", config = {}): Promise<IMissionInfoQueryOneResp> => {
      return request({
        url: `/mission/queryDetail/${code}`,
        method: "GET",
        ...config
    ...
    /**
      ...
      */
    MissionQueryDetailByCodeMissionIdGET: (code: string = "", config = {}): Promise<IMissionInfoQueryOneResp> => {
      return request({
        url: `/mission/queryDetail/${code}`,
        method: "GET",
        ...config
    ...
    /**
      ...
      */
    MissionQueryListPOST: (data: IMissionInfoListReq = {}, config = {}): Promise<IPageResultMissionInfoListResp> => {
      return request({
    ...
    MissionQuestDepositWayListGET: (config = {}): Promise<IDepositWayListResp[]> => {
      return request({
    ...
    MissionQuestList$missionId$GET: (code: string = "", config = {}): Promise<IMissionQuestInfoListResp[]> => {
      return request({
    ...
    /**
     * @description: 任务项-任务项列表  */
    MissionQuestListByCodeGET: (code: string = "", config = {}): Promise<IMissionQuestInfoListResp[]> => {
      return request({
        url: `/mission/quest/list/${code}`,
        method: "GET",
        ...config
    ...
    /**
     * @description: 任务项-任务项列表  */
    MissionQuestListByCodeMissionIdGET: (code: string = "", config = {}): Promise<IMissionQuestInfoListResp[]> => {
      return request({
        url: `/mission/quest/list/${code}`,
        method: "GET",
        ...config
    ...
    /**
      ...
      */
    MissionQuestSavePOST: (data: IMissionQuestCreateOrUpdateReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    MissionQuestTypeListGET: (config = {}): Promise<IMissionQuestInfoTypeListResp[]> => {
      return request({
    ...
    /**
      ...
      */
    MissionRewardAuditPOST: (data: IShenPiRenWuJiangLiQingQiu = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    MissionRewardBatchPassPOST: (data: IPiLiangTongGuoRenWuJiangLiQingQiu = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    MissionRewardQueryListPOST: (data: IMissionUserQuestRewardListReq = {}, config = {}): Promise<IPageResultMissionUserQuestRewardListResp> => {
      return request({
    ...
    /**
      ...
      */
    MissionSavePOST: (data: IMissionCreateOrUpdateReq = {}, config = {}): Promise<number> => {
      return request({
        url: `/mission/save`,
        method: "POST",
        data,
