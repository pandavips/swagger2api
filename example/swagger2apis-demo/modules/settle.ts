...
export default (request) => {
  return {
    /**
      ...
      */
    SettleAgentPOST: (data: IAgentSettleReq = {}, config = {}): Promise<IPageResultAgentSettleResp> => {
      return request({
        url: `/settle/agent`,
        method: "POST",
        data,
    ...
    /**
      ...
      */
    SettleAgentExportExcelGET: (data: ISettleagentexportExcelQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    SettleApplyCheckPassPOST: (data: ICheckPassReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    SettleApplyListPOST: (data: IAgentSettleReq = {}, config = {}): Promise<IPageResultAgentSettleApplyResp> => {
      return request({
    ...
    /**
      ...
      */
    SettlePlatformPOST: (data: IPlatformSettleReq = {}, config = {}): Promise<IPageResultPlatformSettleResp> => {
      return request({
        url: `/settle/platform`,
        method: "POST",
        data,
    ...
    /**
      ...
      */
    SettlePlatformExportExcelGET: (data: ISettleplatformexportExcelQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    SettleProxyPOST: (data: IPlatformSettleReq = {}, config = {}): Promise<IPageResultProxySettleResp> => {
      return request({
        url: `/settle/proxy`,
        method: "POST",
        data,
    ...
    /**
      ...
      */
    SettleProxyExportExcelGET: (data: ISettleproxyexportExcelQueryParams = {}, config = {}): Promise<null> => {
      return request({
