...
export default (request) => {
  return {
    /**
      ...
      */
    ExperienceValueQueryListPOST: (data: IPaging = {}, config = {}): Promise<IPageResultProxyExperienceValueResp> => {
      return request({
    ...
    /**
      ...
      */
    ExperienceValueQueryOnePOST: (data: IQueryExperienceValueReq = {}, config = {}): Promise<IProxyExperienceValueResp> => {
      return request({
    ...
    ExperienceValueQueryValidAmountGET: (config = {}): Promise<IProxyValidAmountResp[]> => {
      return request({
    ...
    /**
      ...
      */
    ExperienceValueUpdateExperienceValuePOST: (data: IUpdateExperienceValueReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    ExperienceValueUpdateValidAmountPOST: (data: IUpdateValidAmountReq[] = {}, config = {}): Promise<null> => {
      return request({
