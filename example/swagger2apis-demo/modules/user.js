...
export default (request) => {
  return {
    ...
    /**
          ...
          */
    UserBankCardDeleteCardPOST: (data = {}, config = {}) => {
      return request({
    ...
    UserDisableUserBatchPOST: (data = {}, config = {}) => {
      return request({
    ...
    UserEnableUserBatchPOST: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    UserGetRelationUserInfoPOST: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    UserReminderListPOST: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    UserUpdateUserPOST: (data = {}, config = {}) => {
      return request({
        url: `/user/updateUser`,
        method: "POST",
        data,
