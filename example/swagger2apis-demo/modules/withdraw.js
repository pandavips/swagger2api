...
export default (request) => {
  return {
    /**
          ...
          */
    WithdrawConfigGetDigital$chain$POST: (code = "", config = {}) => {
      return request({
    ...
    /**
          ...
          */
    WithdrawConfigGetDigitalByCodePOST: (code = "", config = {}) => {
      return request({
        url: `/withdraw/config/getDigital/${code}`,
        method: "POST",
        ...config
    ...
    /**
          ...
          */
    WithdrawConfigGetDigitalByCodeChainPOST: (code = "", config = {}) => {
      return request({
        url: `/withdraw/config/getDigital/${code}`,
        method: "POST",
        ...config
    ...
    /**
          ...
          */
    WithdrawConfigGetLeger$currencyCode$POST: (code = "", config = {}) => {
      return request({
    ...
    /**
          ...
          */
    WithdrawConfigGetLegerByCodePOST: (code = "", config = {}) => {
      return request({
        url: `/withdraw/config/getLeger/${code}`,
        method: "POST",
        ...config
    ...
    /**
          ...
          */
    WithdrawConfigGetLegerByCodeCurrencyCodePOST: (code = "", config = {}) => {
      return request({
        url: `/withdraw/config/getLeger/${code}`,
        method: "POST",
        ...config
    ...
    WithdrawLimitAdjustRecord$userId$GET: (code = "", config = {}) => {
      return request({
    ...
    /**
     * @description: 提现/币限制-调整记录  */
    WithdrawLimitAdjustRecordByCodeGET: (code = "", config = {}) => {
      return request({
        url: `/withdraw/limit/adjust/record/${code}`,
        method: "GET",
        ...config
    ...
    /**
     * @description: 提现/币限制-调整记录  */
    WithdrawLimitAdjustRecordByCodeUserIdGET: (code = "", config = {}) => {
      return request({
        url: `/withdraw/limit/adjust/record/${code}`,
        method: "GET",
        ...config
