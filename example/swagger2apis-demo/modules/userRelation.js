...
export default (request) => {
  return {
    /**
          ...
          */
    UserRelationStatisticsExportSubExcelGET: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    UserRelationStatisticsExportTargetExcelGET: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    UserRelationStatisticsSubPOST: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    UserRelationStatisticsTargetPOST: (data = {}, config = {}) => {
      return request({
