...
export default (request) => {
  return {
    ...
    /**
          ...
          */
    DepositConfigGetDigital$chain$POST: (code = "", config = {}) => {
      return request({
    ...
    /**
          ...
          */
    DepositConfigGetDigitalByCodePOST: (code = "", config = {}) => {
      return request({
        url: `/deposit/config/getDigital/${code}`,
        method: "POST",
        ...config
    ...
    /**
          ...
          */
    DepositConfigGetDigitalByCodeChainPOST: (code = "", config = {}) => {
      return request({
        url: `/deposit/config/getDigital/${code}`,
        method: "POST",
        ...config
    ...
    /**
          ...
          */
    DepositConfigGetLeger$currencyCode$POST: (code = "", config = {}) => {
      return request({
    ...
    /**
          ...
          */
    DepositConfigGetLegerByCodePOST: (code = "", config = {}) => {
      return request({
        url: `/deposit/config/getLeger/${code}`,
        method: "POST",
        ...config
    ...
    /**
          ...
          */
    DepositConfigGetLegerByCodeCurrencyCodePOST: (code = "", config = {}) => {
      return request({
        url: `/deposit/config/getLeger/${code}`,
        method: "POST",
        ...config
    ...
    /**
          ...
          */
    DepositStatisticsAgentTopNPOST: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    DepositStatisticsAgentTopNExportExcelGET: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    DepositStatisticsUserTopNPOST: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    DepositStatisticsUserTopNExportExcelGET: (data = {}, config = {}) => {
      return request({
