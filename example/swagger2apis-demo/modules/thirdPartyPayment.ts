...
export default (request) => {
  return {
    /**
      ...
      */
    ThirdPartyPaymentAddOrUpdatePOST: (data: IThirdPayUpdateReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    ThirdPartyPaymentDeleteGET: (data: IThirdPartyPaymentdeleteQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    ThirdPartyPaymentDetailGET: (data: IThirdPartyPaymentdetailQueryParams = {}, config = {}): Promise<IThirdPayDetailResp> => {
      return request({
    ...
    /**
      ...
      */
    ThirdPartyPaymentListPOST: (data: IThirdPayListReq = {}, config = {}): Promise<IThirdPayListResp[]> => {
      return request({
