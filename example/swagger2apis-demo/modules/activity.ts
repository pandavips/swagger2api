...
export default (request) => {
  return {
    /**
      ...
      */
    ActivityEditActivityPOST: (data: IEditActivityReq = {}, config = {}): Promise<IEditActivityResp> => {
      return request({
    ...
    /**
      ...
      */
    ActivityEditStatusPOST: (data: IEditActivityStatusReq = {}, config = {}): Promise<string> => {
      return request({
    ...
    ActivityExportGET: (config = {}): Promise<null> => {
      return request({
        url: `/activity/export`,
        method: "GET",
        ...config
    ...
    /**
     * @description: 活动相关-导出Excel  */
    ActivityExportPOST: (config = {}): Promise<null> => {
      return request({
        url: `/activity/export`,
        method: "POST",
        ...config
    ...
    /**
      ...
      */
    ActivityFetchActivityDetailPOST: (data: IQueryActivityDetailReq = {}, config = {}): Promise<IQueryActivityDetailResp> => {
      return request({
    ...
    /**
      ...
      */
    ActivityQueryActivityPOST: (data: IQueryActivityReq = {}, config = {}): Promise<IPageResultQueryActivityResp> => {
      return request({
