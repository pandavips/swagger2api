...
export default (request) => {
  return {
    /**
      ...
      */
    SystemAdjustmentAddPOST: (data: IAdjustmentReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    SystemAdjustmentGetProxyAdjustSumGET: (config = {}): Promise<IProxySumResp> => {
      return request({
    ...
    /**
      ...
      */
    SystemAdjustmentQueryPOST: (data: IPaging = {}, config = {}): Promise<IPageResultSystemDepositWithdrawBo> => {
      return request({
    ...
    /**
      ...
      */
    SystemGetRewardRatePOST: (config = {}): Promise<IProxyRewardRateResp> => {
      return request({
    ...
    /**
      ...
      */
    SystemGetSummaryPOST: (config = {}): Promise<IProxySummerResp> => {
      return request({
    ...
    /**
      ...
      */
    SystemMenuAddPOST: (data: IMenuBaseVo = {}, config = {}): Promise<string> => {
      return request({
        url: `/system/menu/add`,
        method: "POST",
        data,
    ...
    /**
      ...
      */
    SystemMenuDeleteGET: (data: ISystemmenudeleteQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    SystemMenuDeletePOST: (data: ISystemmenudeleteQueryParams = {}, config = {}): Promise<null> => {
      return request({
        url: `/system/menu/delete`,
        method: "POST",
        params: data,
    ...
    SystemMenuQueryAllGET: (config = {}): Promise<IMenuResponseVo[]> => {
      return request({
    ...
    /**
      ...
      */
    SystemMenuUpdatePOST: (data: IMenuUpdateVo = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    SystemRoleAddPOST: (data: IRoleBaseVo = {}, config = {}): Promise<string> => {
      return request({
        url: `/system/role/add`,
        method: "POST",
        data,
    ...
    /**
      ...
      */
    SystemRoleAuthorizeMenuPOST: (data: IRoleMenuRequestVo = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    SystemRoleChangeLockPOST: (data: IRoleLockRequestVo = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    SystemRoleDeleteGET: (data: ISystemroledeleteQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    SystemRoleDeletePOST: (data: ISystemroledeleteQueryParams = {}, config = {}): Promise<null> => {
      return request({
        url: `/system/role/delete`,
        method: "POST",
        params: data,
    ...
    SystemRoleQueryAllGET: (config = {}): Promise<IJiaoSeXiangYingXinXi[]> => {
      return request({
    ...
    /**
      ...
      */
    SystemRoleQueryByIdGET: (data: ISystemrolequeryByIdQueryParams = {}, config = {}): Promise<IJiaoSeXiangYingXinXi> => {
      return request({
    ...
    /**
      ...
      */
    SystemRoleQueryDetailGET: (data: ISystemrolequeryDetailQueryParams = {}, config = {}): Promise<IRoleMenuResponseVo> => {
      return request({
    ...
    /**
      ...
      */
    SystemRoleQueryPagingPOST: (data: IRoleQueryRequestVo = {}, config = {}): Promise<IPageResultJiaoSeXiangYingXinXi> => {
      return request({
    ...
    /**
      ...
      */
    SystemRoleUpdatePOST: (data: IRoleUpdateVo = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    SystemUpdateSummaryPOST: (data: IProxyBaseUpdateReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    SystemUserChangePasswordPOST: (data: IUserPasswordRequestProxyVo = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    SystemUserGetRoleGET: (data: ISystemusergetRoleQueryParams = {}, config = {}): Promise<IJiaoSeXiangYingXinXi[]> => {
      return request({
    ...
    /**
      ...
      */
    SystemUserGetRoleMenuGET: (config = {}): Promise<IUserRoleMenuVo> => {
      return request({
