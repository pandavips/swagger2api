...
export default (request) => {
  return {
    /**
      ...
      */
    AssetChangeLogExportExcelGET: (data: IAssetChangeLogexportExcelQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    AssetChangeLogListPOST: (data: IAssetChangeLogReq = {}, config = {}): Promise<IPageResultAssetChangeLogResp> => {
      return request({
    ...
    AssetChangeLogTypeGET: (config = {}): Promise<IAssetChangeLogType[]> => {
      return request({
