...
export default (request) => {
  return {
    /**
      ...
      */
    RebatePlanAddPlanPOST: (data: IXinZengFanShuiFangAnQingQiu = {}, config = {}): Promise<number> => {
      return request({
    ...
    RebatePlanAllTypeGET: (config = {}): Promise<IChannelTypeResp[]> => {
      return request({
    ...
    /**
      ...
      */
    RebatePlanDeleteItemsPOST: (data: IDeleteItemsReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    RebatePlanDeletePlanPOST: (data: IPlanIdReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    RebatePlanDisablePlanPOST: (data: IPlanIdReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    RebatePlanEnablePlanPOST: (data: IPlanIdReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    RebatePlanQueryItemsPOST: (data: IPlanIdReq = {}, config = {}): Promise<IFanShuiFangAnMingXiXinXi[]> => {
      return request({
    ...
    /**
      ...
      */
    RebatePlanQueryListPOST: (data: IPlanQueryReq = {}, config = {}): Promise<IPageResultFanShuiFangAnXinXi> => {
      return request({
    ...
    /**
      ...
      */
    RebatePlanUpdatePlanPOST: (data: IGengXinFanShuiFangAnQingQiu = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    RebateRecordAllGrantPOST: (data: IRecordQueryReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    RebateRecordBatchGrantPOST: (data: IRecordIdsReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    RebateRecordBatchRefusePOST: (data: IRecordIdsReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    RebateRecordExportExcelGET: (data: IRebaterecordexportExcelQueryParams = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    RebateRecordQueryListPOST: (data: IRecordQueryReq = {}, config = {}): Promise<IPageResultProxyRebateRecordResp> => {
      return request({
