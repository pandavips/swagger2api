...
export default (request) => {
  return {
    /**
          ...
          */
    RakebackAuditBatchPOST: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    RakebackConfigRulePOST: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    RakebackGetRule$type$GET: (code = "", config = {}) => {
      return request({
    ...
    /**
          ...
          */
    RakebackGetRuleByCodeGET: (code = "", config = {}) => {
      return request({
        url: `/rakeback/getRule/${code}`,
        method: "GET",
        ...config
    ...
    /**
          ...
          */
    RakebackGetRuleByCodeTypeGET: (code = "", config = {}) => {
      return request({
        url: `/rakeback/getRule/${code}`,
        method: "GET",
        ...config
    ...
    /**
          ...
          */
    RakebackRecordListPOST: (data = {}, config = {}) => {
      return request({
    ...
    /**
          ...
          */
    RakebackStatistics$type$POST: (code = "", config = {}) => {
      return request({
    ...
    /**
          ...
          */
    RakebackStatisticsByCodePOST: (code = "", config = {}) => {
      return request({
        url: `/rakeback/statistics/${code}`,
        method: "POST",
        ...config
    ...
    /**
          ...
          */
    RakebackStatisticsByCodeTypePOST: (code = "", config = {}) => {
      return request({
        url: `/rakeback/statistics/${code}`,
        method: "POST",
        ...config
