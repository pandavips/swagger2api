...
export default (request) => {
  return {
    /**
      ...
      */
    CmsArticleAddPOST: (data: IAddArticleReq = {}, config = {}): Promise<null> => {
      return request({
        url: `/cms/article/add`,
        method: "POST",
        data,
    ...
    /**
      ...
      */
    CmsArticleDisablePOST: (data: IArticleIdReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    CmsArticlePublishPOST: (data: IArticleIdReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    CmsArticleQueryListPOST: (data: IQueryArticleReq = {}, config = {}): Promise<IPageResultArticleResp> => {
      return request({
    ...
    /**
      ...
      */
    CmsArticleQueryOnePOST: (data: IArticleIdReq = {}, config = {}): Promise<IArticleResp> => {
      return request({
    ...
    /**
      ...
      */
    CmsArticleUpdatePOST: (data: IUpdateArticleReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    CmsBannerAddPOST: (data: IAddBannerReq = {}, config = {}): Promise<null> => {
      return request({
        url: `/cms/banner/add`,
        method: "POST",
        data,
    ...
    /**
      ...
      */
    CmsBannerDisablePOST: (data: IBannerNoReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    CmsBannerPublishPOST: (data: IBannerNoReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    CmsBannerQueryListPOST: (data: IQueryBannerReq = {}, config = {}): Promise<IPageResultBannerResp> => {
      return request({
    ...
    /**
      ...
      */
    CmsBannerQueryOnePOST: (data: IBannerNoReq = {}, config = {}): Promise<IBannerResp> => {
      return request({
    ...
    /**
      ...
      */
    CmsBannerUpdatePOST: (data: IUpdateBannerReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    CmsLabelQueryAllGET: (config = {}): Promise<IUserLabelResp[]> => {
      return request({
