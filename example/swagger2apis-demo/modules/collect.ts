...
export default (request) => {
  return {
    /**
      ...
      */
    CollectGetGET: (config = {}): Promise<ICollectResp> => {
      return request({
        url: `/collect/get`,
        method: "GET",
        ...config
    ...
    /**
      ...
      */
    CollectUpdateCollectPOST: (data: IAddressReq = {}, config = {}): Promise<null> => {
      return request({
    ...
    /**
      ...
      */
    CollectUpdateHotPOST: (data: IPrivateKeyReq = {}, config = {}): Promise<null> => {
      return request({
